...
class ConsoleViewControllerTest: XCTestCase {
    ...
    func testPerformanceExample() {
        ...
        self.measure {
            ...
            for _ in 0...150 {
                consoleViewController.windmill(windmill, standardOutput: standardOutput, count: 4096)
            }
    ...
    func testGivenConsoleViewNotLoadedAssertConsoleLogNotMissingTheOutputAfterLoad() {
        ...
        let first = "first"
        consoleViewController.windmill(windmill, standardOutput: first, count: first.count)
        consoleViewController.loadView()
        let second = "second"
        consoleViewController.windmill(windmill, standardOutput: second, count: second.count)
    ...
    func testGivenConsoleViewNotLoadedAssertConsoleLogNotMissingPreviousOutputAfterLoad() {
        ...
        let third = "third"
        consoleViewController.loadView()
        consoleViewController.windmill(windmill, standardOutput: third, count: third.count)
