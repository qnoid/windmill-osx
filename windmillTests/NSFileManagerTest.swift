...
class NSFileManagerTest : XCTestCase
{
    ...
    func testGivenBuildDirectoryURLAssertPath() {
        let buildDirectoryURL = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).buildDirectoryURL()
        
        XCTAssertEqual("/Users/qnoid/.windmill/foo/build", buildDirectoryURL.path)
    }
    
    func testGivenTestDirectoryURLAssertPath() {
        let testDirectoryURL = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).testDirectoryURL()
        
        XCTAssertEqual("/Users/qnoid/.windmill/foo/test", testDirectoryURL.path)
    }

    func testGivenArchiveDirectoryURLAssertPath() {
        let archiveDirectoryURL = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).archiveDirectoryURL()
        
        XCTAssertEqual("/Users/qnoid/.windmill/foo/archive", archiveDirectoryURL.path)
    }

    func testGivenArchiveInfoURLAssertPath() {
        let archive = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).archive(name: "bar")
    ...
    func testGivenExportDirectoryURLAssertPath() {
        let exportDirectoryURL = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).exportDirectoryURL()
        
        XCTAssertEqual("/Users/qnoid/.windmill/foo/export", exportDirectoryURL.path)
    }

    func testGivenPollDirectoryURLAssertPath() {
        let pollDirectoryURL = FileManager.default.windmillDirectory.directory(for: Project(name: "foo", scheme: "schmee", origin: "any")).pollURL()
